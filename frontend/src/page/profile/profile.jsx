      ...
      <div className="profile mt-5">
        <div className="container">
              ...
              <div className="profile-image border shadow-md rounded-full ">
                {
                  error ? (
                    <div>
                      <img src={DemoPrfileImage} className=" border w-[80px] h-[80px] rounded-full shadow-md " alt="" />
                    </div>
                  ) : (
                    <div>
                      {
                      getUser.map((img, index) => (
                        <div key={index} className="data-content" >
                          <img src={img.url} alt={`getUser ${index + 1}`} className="w-[80px] h-[80px] rounded-full  shadow-md border  " />
                        </div>
                      ))
                      }
                    </div>
          ...
          <div className="gear-option mt-5 m-3 p-2 pl-2 rounded-md flex justify-between border ">
            <div className="notification flex gap-5 items-center " onClick={HandleNotification} >
